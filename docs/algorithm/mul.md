...
![Dezimales Multiplikationsmodell](dezimales_modell.png)
...
![128-Bit-Alignment der Teilprodukte](teilprodukte_alignment_128bit.png)
...
![C++ Registermodell](cpp_registermodell_sequentiell.png)
...
![Sequentielle Überführung ins ByteArray](cpp_ueberfuehrung_bytearray_sequentiell.png)